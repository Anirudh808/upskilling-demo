...
export const users: User[] = [
  {
    ...
    skills: ["React", "Node.js", "Python", "SQL", "DSA"],
  ...
  },
  {
    ...
    verificationStatus: "Verified",
    resumeStatus: "Complete",
    skills: ["React", "TypeScript", "GraphQL", "Docker", "K8s"],
  ...
  },
  {
    ...
    verificationStatus: "Verified",
    resumeStatus: "Complete",
    skills: ["Go", "Rust", "System Design", "AWS"],
...
export const courses: Course[] = [
  {
    ...
    modules: [
      {
        id: "m1",
        title: "Fundamentals of HTTP & REST",
        completed: true,
        lessons: [
...
export const verifications: Verification[] = [
  {
    ...
    date: "2026-01-15",
    flags: [],
    certificateId: "CERT-RCT-2026-A7B3",
  },
  {
    id: "v2",
    skill: "DSA",
    ...
    date: "2026-01-08",
    flags: [],
    certificateId: "CERT-DSA-2026-K9L2",
  },
  {
    id: "v3",
    skill: "SQL",
...
export const projects: Project[] = [
  {
    ...
    description:
      "A full-stack REST API with authentication, product CRUD, cart management, and Stripe payments.",
    milestones: [
      {
        id: "ms1",
        ...
        aiScore: 95,
        feedback:
          "Excellent project structure with proper TypeScript configuration.",
      },
      {
        id: "ms2",
        title: "API Design & Routes",
        status: "Complete",
        aiScore: 88,
        feedback:
          "Good REST conventions. Consider adding pagination to list endpoints.",
      },
      {
        id: "ms3",
        ...
        aiScore: 82,
        feedback:
          "JWT implementation is solid. Add refresh token rotation for production.",
      },
      {
        id: "ms4",
  ...
  },
  {
    ...
    description:
      "WebSocket-based chat app with rooms, typing indicators, and message persistence.",
    milestones: [
      {
        id: "ms6",
        title: "Project Setup",
        status: "Complete",
        aiScore: 90,
        feedback: "Clean setup with good dependency choices.",
      },
...
export const certificates: Certificate[] = [
  {
    ...
    authenticityId: "CERT-RCT-2026-A7B3-BLOCKCHAIN-0x8a9f",
    holder: "Priya Sharma",
    score: 87,
  },
  {
    ...
    authenticityId: "CERT-DSA-2026-K9L2-BLOCKCHAIN-0x3c2d",
    holder: "Priya Sharma",
    score: 92,
  },
];
...
export const roadmapSteps = [
  {
    id: "rs1",
    title: "Complete Middleware & Error Handling lesson",
    type: "Learning",
    done: false,
  },
  {
  ...
  {
    id: "rs3",
    title: "Take SQL Intermediate verification",
    type: "Verification",
    done: false,
  },
  {
    id: "rs4",
    title: "Finish DB Schema milestone in project",
    type: "Project",
    done: false,
  },
  {
    id: "rs5",
    title: "Schedule a Mock Technical Interview",
    type: "Interview",
    done: false,
  },
];
...
export const navItems = {
  student: [
    {
      ...
      items: [
        ...
        { label: "My Courses", href: "/my-courses", icon: "Video" },
      ],
    },
    {
      group: "Verify",
      items: [
        { label: "Certifications", href: "/verify", icon: "ShieldCheck" },
  ...
  recruiter: [
    ...
    {
      group: "Manage",
      items: [{ label: "HRMS Integration", href: "/hrms", icon: "Settings" }],
    },
  ],
  admin: [
    {
